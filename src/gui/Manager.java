...
public class Manager extends javax.swing.JFrame {
    ...
    public Manager() {
        ...
        DefaultTableModel model_today = (DefaultTableModel) tbl_walkin.getModel();
        sorter_today = new TableRowSorter<>(model_today);
        tbl_walkin.setRowSorter(sorter_today);
        
        DefaultTableModel model_today2 = (DefaultTableModel) tbl_res.getModel();
        sorter_today2 = new TableRowSorter<>(model_today2);
        tbl_res.setRowSorter(sorter_today2);
        ...
        for (int i = 0; i < tbl_walkin.getColumnCount(); i++) {
            tbl_walkin.getColumnModel().getColumn(i).setCellRenderer(center_today);
        }
        ...
        for (int i = 0; i < tbl_res.getColumnCount(); i++) {
            tbl_res.getColumnModel().getColumn(i).setCellRenderer(center_today2);
        }
    ...
    sorter_IHR.setComparator(5, (t1, t2) -> {
        ...
        DefaultTableCellRenderer headerRenderer = (DefaultTableCellRenderer) tbl_walkin.getTableHeader().getDefaultRenderer();
        ...
        DefaultTableCellRenderer headerRenderer5 = (DefaultTableCellRenderer) tbl_res.getTableHeader().getDefaultRenderer();
    ...
    // Set the label text to show the total PAX
        ...
        int totalPax = 0;
        int count = tbl_walkin.getRowCount();
    ...
    // Set the label text to show the total PAX
        lbl_totalwalkin.setText("TOTAL WALKIN: " + totalPax);
    }

    private void updateTotalavail() {
        int totalres = 0;
        int totalavail = 0;
        int rcount = tbl_res.getRowCount();

        for (int i = 0; i < rcount; i++) {
        // Assuming PAX is in the last column, index 5 (0-based)
            Object paxValue = tbl_res.getValueAt(i, 6);
            if (paxValue != null) {
                try {
                    int pax = Integer.parseInt(paxValue.toString());
                    totalres += pax;
    ...
    // Set the label text to show the total PAX 
        totalavail = 100 - (totalwalkin - totalres);
        lbl_availseats.setText("AVAILABLE SEATS: " + totalavail);
    }
    ...
    private void initComponents() {
        ...
        lbl_reservation1 = new javax.swing.JLabel();
        lbl_totalwalkin = new javax.swing.JLabel();
        lbl_availseats = new javax.swing.JLabel();
        ...
        pnl_dine_in.add(lbl_totalres, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 430, 170, 40));
        ...
        pnl_dine_in.add(lbl_search, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 50, 60, 40));
        ...
        pnl_dine_in.add(search_today, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 60, 170, -1));
        ...
        tbl_walkin.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, "09357873489", null, "Lunch",  new Integer(4), null, "4"},
                {null, "09174532356", null, "Lunch",  new Integer(3), null, "5"},
                {null, "09876541453", null, "Dinner",  new Integer(2), null, "1"},
                {null, "09258653421", null, "Dinner",  new Integer(6), null, "2"},
                {null, "09987823421", null, "Lunch",  new Integer(7), null, "6"}
            },
            new String [] {
        ...
        pnl_dine_in.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 270, 700, 160));
        ...
        pnl_dine_in.add(lbl_walkin, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 250, 150, 20));
        ...
        tbl_res.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"Juan Dela Cruz", null, "09357873489", null, "Lunch",  new Integer(4), null, "2"},
                {"Maria Santos", null, "09174532356", null, "Lunch",  new Integer(3), null, "2"},
                {"Louise Lopez", null, "09876541453", null, "Dinner",  new Integer(2), null, "4"},
                {"Rhian Espinosa", null, "09258653421", null, "Dinner",  new Integer(6), null, "50"},
                {"Justine Dizon", null, "09987823421", null, "Lunch",  new Integer(7), null, "7"}
            },
            new String [] {
                "VIP ID", "FIRST NAME", "LAST NAME", "CONTACT", "GENDER", "DATE", "TIME", "PAX"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.Object.class, java.lang.String.class, java.lang.Object.class, java.lang.Object.class, java.lang.Integer.class, java.lang.Object.class, java.lang.Object.class
            };
            boolean[] canEdit = new boolean [] {
        ...
        jScrollPane5.setViewportView(tbl_res);
        ...
        pnl_dine_in.add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 700, 150));

        lbl_reservation1.setFont(new java.awt.Font("Century Gothic", 1, 16)); // NOI18N
        lbl_reservation1.setForeground(new java.awt.Color(102, 102, 102));
        lbl_reservation1.setText("Reservations");
        pnl_dine_in.add(lbl_reservation1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, 150, 20));
        ...
        pnl_dine_in.add(lbl_totalwalkin, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 430, 170, 40));

        lbl_availseats.setFont(new java.awt.Font("Century Gothic", 1, 16)); // NOI18N
        lbl_availseats.setForeground(new java.awt.Color(102, 102, 102));
        lbl_availseats.setText("Total:");
        pnl_dine_in.add(lbl_availseats, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 430, 180, 40));
        ...
        tbl_history.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"Juan Dela Cruz", null, "09357873489", "03-26-26", "Lunch",  new Integer(4), null},
                {"Maria Santos", null, "09174532356", "03-01-26", "Lunch",  new Integer(3), null},
                {"Louise Lopez", null, "09876541453", "04-19-26", "Lunch",  new Integer(2), null},
                {"Rhian Espinosa", null, "09258653421", "03-01-26", "Dinner",  new Integer(6), null},
                {"Justine Dizon", null, "09987823421", "04-19-26", "Dinner",  new Integer(7), null}
            },
            new String [] {
                "FIRST NAME", "LAST NAME", "CONTACT", "GENDER", "DATE", "TIME", "PAX"
            }
            ...
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.Object.class, java.lang.String.class, java.lang.Object.class, java.lang.Object.class, java.lang.Integer.class, java.lang.Object.class
            };
            boolean[] canEdit = new boolean [] {
    ...
    TableRowSorter sorter = (TableRowSorter) tbl_walkin.getRowSorter();
 ...
 * 
    ...
    private javax.swing.JLabel lbl_availseats;
    private javax.swing.JLabel lbl_ihr;
    private javax.swing.JLabel lbl_reservation1;
