...
public class Admin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tbl_acc.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"Juan Dela Cruz", "juandcruz@gmail.com", "jdc26", "Customer"},
                {"Jane Santos", "jane.santos@houseofseven.com", "janesantos0", "Front Desk"},
                {"admin", "admin@email.com", "000000", "ADMIN"}
            },
            new String [] {
                "USERNAME", "EMAIL", "PASSWORD", "ACC TYPE"
            }
        ) {
        ...
        if (tbl_acc.getColumnModel().getColumnCount() > 0) {
            ...
            tbl_acc.getColumnModel().getColumn(3).setResizable(false);
        }
