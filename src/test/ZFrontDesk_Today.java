 ...
 * @author kyshgel
 */
public class ZFrontDesk_Today extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(ZFrontDesk_Today.class.getName());
 ...
 * 
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new ZFrontDesk_Today().setVisible(true));
    }
